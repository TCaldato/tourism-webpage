...
<body>
    ...
    <main class="flex-container1">
        <section class="section1" id="section1">
            <div class="section1-description">
                <h1 id="section1-title-signin"><stronge>Flex Tourism </stronge></h1>
        ...
        <section class="section2" id="section2">
            ...
            <div class="section2-description">
                <h2 id="section2-title-signin"><stronge>Who we are</stronge></h2>
    ...
    <section class="section4">
        <div id="section4-title-signin">
            <h2>Plans</h2>
        </div>

        <div class="section4-container"> 

            <div class="section4-Plans-signin">
                ...
                <button id="section4-button-signin"><a id="section4-link-signin" href="https://www.getyourguide.co.uk/" 
                target="_blank" >Try your best Tour Guide</a></button>
            </div>
            ...
            <div class="section4-Plans-signin">
                ...
                <button id="section4-button-signin"><a id="section4-link-signin" href="https://www.traillink.com/trail-itinerary/"
                target="_blank">Try your Best Trails</a></button>
            </div>
            ...
            <div class="section4-Plans-signin">
                ...
                <button id="section4-button-signin"><a id="section4-link-signin" href="https://www.morrisonhotel.ie/"
                target="_blank" >Your Best Room Service</a></button>
            </div>
        </div>
    </section>
